...
SECRET_KEY = 'django-insecure-k%1wcdwz4w193i9*=cg^v0^ymjswzae33pd$x10@_ypev#lw5#'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'blog', 'static')]   #현재 static파일의 경로 명시

STATIC_ROOT = os.path.join(BASE_DIR, 'static')  #static 파일을 어디에 모을건지

MEDIA_ROOT = os.path.join(BASE_DIR, 'media')    # 사용자가 업로드한 파일을 모으는 곳
